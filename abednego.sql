...
INSERT IGNORE INTO `projet` (`idProjet`, `nomProjet`, `typeProjet`, `dateCreation`) VALUES
...
INSERT IGNORE INTO `projet_prospecteur` (`idProjet`, `idProspecteur`) VALUES
	(1, 2),
	(1, 7),
	(2, 8);
...
INSERT IGNORE INTO `prospecteur` (`idProspecteur`, `nomUtilisateur`, `motDePasse`, `mail`, `phone`, `nom`, `prenom`) VALUES
...
INSERT IGNORE INTO `question` (`idQuestion`, `idProjet`, `numeroQuestion`, `typeDeQuestion`, `question`) VALUES
...
INSERT IGNORE INTO `reponse` (`idReponse`, `idProjet`, `idQuestion`, `numeroReponse`, `reponse`) VALUES
	(1, 1, 1, 1, 'oui'),
	(2, 1, 1, 2, 'non'),
	(3, 1, 1, 3, 'oui'),
	(4, 2, 5, 1, 'A'),
...
-- Listage de la structure de table abednego. utilisateur
DROP TABLE IF EXISTS `utilisateur`;
CREATE TABLE IF NOT EXISTS `utilisateur` (
  `idUtilisateur` int DEFAULT NULL,
  `nomUtilisateur` varchar(150) DEFAULT NULL,
  `motDePasse` varchar(150) DEFAULT NULL,
  `adresse` varchar(150) DEFAULT NULL,
  `mail` varchar(150) DEFAULT NULL,
  `telephone` varchar(150) DEFAULT NULL,
  `matricule` varchar(150) DEFAULT NULL,
  `niveau` varchar(150) DEFAULT NULL,
  `parcours` varchar(150) DEFAULT NULL,
  `fichierUpload` blob,
  `payement` varchar(50) DEFAULT NULL,
  `nom` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Listage des données de la table abednego.utilisateur : ~0 rows (environ)
INSERT IGNORE INTO `utilisateur` (`idUtilisateur`, `nomUtilisateur`, `motDePasse`, `adresse`, `mail`, `telephone`, `matricule`, `niveau`, `parcours`, `fichierUpload`, `payement`, `nom`) VALUES
	(1, 'john', '123456', 'tanambao', 'fetra@mail.com', '034 13 136 55', '1081', 'l1', 'IG', NULL, 'impayé', 'fetra');
